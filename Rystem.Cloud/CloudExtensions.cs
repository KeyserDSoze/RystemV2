...
namespace System
{
    public static class CloudExtensions
    {
        ...
        public static async Task<(Tenant Tenant, List<CloudManagementError> Errors)> GetTenantAsync<TEntry>(this TEntry entry, DateTime from, DateTime to, ManagementDeepRequest deepRequest = ManagementDeepRequest.Monitoring, bool executeRequestInParallel = false, Installation installation = Installation.Default)
            where TEntry : ICloud
            => await entry.GetCloudManagement(installation).GetTenantAsync(from, to, deepRequest, executeRequestInParallel).NoContext();
        public static async Task<(Tenant Tenant, List<CloudManagementError> Errors)> GetTenantAsync<TEntry>(this TEntry entry, DateTime month, ManagementDeepRequest deepRequest = ManagementDeepRequest.Monitoring, bool executeRequestInParallel = false, Installation installation = Installation.Default)
            where TEntry : ICloud
        ...
        public static async Task<(Subscription Subscription, List<CloudManagementError> Errors)> GetSubscriptionAsync<TEntry>(this TEntry entry, string subscriptionId, DateTime from, DateTime to, ManagementDeepRequest deepRequest = ManagementDeepRequest.Monitoring, bool executeRequestInParallel = false, Installation installation = Installation.Default)
            where TEntry : ICloud
        ...
        public static async Task<(Subscription Subscription, List<CloudManagementError> Errors)> GetSubscriptionAsync<TEntry>(this TEntry entry, string subscriptionId, DateTime month, ManagementDeepRequest deepRequest = ManagementDeepRequest.Monitoring, bool executeRequestInParallel = false, Installation installation = Installation.Default)
            where TEntry : ICloud
        ...
        public static Task<(Tenant Tenant, List<CloudManagementError> Errors)> GetPreviousMonthTenantAsync<TEntry>(this TEntry entry, ManagementDeepRequest deepRequest = ManagementDeepRequest.Monitoring, bool executeRequestInParallel = false, Installation installation = Installation.Default)
            where TEntry : ICloud
