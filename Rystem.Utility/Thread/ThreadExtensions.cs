...
namespace System
{
    public static class Lock
    {
        ...
        /// <returns></returns>
        public static async Task<LockConditionResponse> RunAsync(this Func<Task> task, string lockId = null)
    ...
    public static class RaceCondition
    {
        ...
        /// <returns></returns>
        public static async Task<RaceConditionResponse> RunAsync(Func<Task> task, string raceId = null)
    ...
    public static class Ghost
    {
        ...
        public static void Run(Action task, int id = 0, int runningTime = 120)
            => task.RunInBackground(id, runningTime);
        /// <summary>
        /// Remove a task from the continuously running by its id.
        /// </summary>
        /// <param name="id">Task id that runs in background.</param>
        public static void Stop(int id = 0)
    ...
    public static class ThreadExtensions
    {
        ...
        /// <param name="lockId">lock key, task with different id doesn't partecipate at the same lock chain.</param>
        /// <returns></returns>
        public static async Task<LockConditionResponse> LockAsync(this Func<Task> task, string lockId = null)
            => await LockConditionInstances.Instance.RunAsync(task, lockId).NoContext();
        /// <summary>
        /// Deal with concurrency and allow only one method to run. Other concurrent task will be dropped.
        /// </summary>
        ...
        /// <param name="raceId">concurrency key, task with different id doesn't partecipate at the same race.</param>
        /// <returns></returns>
        public static async Task<RaceConditionResponse> RunUnderRaceConditionAsync(this Func<Task> task, string raceId = null)
        ...
        /// <param name="id">Task id that runs in background.</param>
        /// <param name="runningTime">Time in milliseconds each time the task runs. Minimum time is 120ms.</param>
        public static void RunInBackground(this Action task, int id = 0, int runningTime = 120)
        ...
        /// <param name="id">Task id that runs in background.</param>
        public static void StopRunningInBackground(this Action task, int id = 0)
